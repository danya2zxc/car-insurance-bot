...
class VehicleDocumentData(BaseModel):
    ...
    model: Optional[str] = Field(
        alias="vehicle_make_and_model", default="N/A", description="Make and model of the vehicle"
    )
    reg_number: Optional[str] = Field(
        alias="registration_number", default="N/A", description="Registration number of the vehicle"
    )
    doc_number: Optional[str] = Field(
        alias="document_series_and_number", default="N/A", description="Document series and number"
    )
